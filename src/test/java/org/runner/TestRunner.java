...
@CucumberOptions(features = { "src\\test\\resources\\Login.feature" }, glue = {
		"org.stepdef" }, monochrome = true, dryRun = false, plugin = { "pretty", "html:D:\\9pmCucumberBatch\\target",
				"json:D:\\9pmCucumberBatch\\target\\fb.json", "junit:D:\\\\9pmCucumberBatch\\\\target\\\\fb.xml",
				"json:D:\\9pmCucumberBatch\\target\\Report\\sample.json" }, snippets = SnippetType.CAMELCASE)
